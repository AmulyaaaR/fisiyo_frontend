...
const LandingPage = () => {
  ...
  <div className="relative z-10 mt-20">
    ...
    <img
      ...
      className="absolute right-[15%] top-[1vh] w-[min(8vw,90px)] h-auto floating-3"
    />
    <img
      src="/images/telescope.png"
      className="absolute bottom-[65%] left-[15%] w-[min(10vw,100px)] h-auto floating-4"
    />
    <img
      src="/images/bulb.png"
      className="absolute bottom-[10%] right-[20%] w-[min(8vw,90px)] h-auto floating-5"
    />
    <img
      src="/images/atom.png"
      className="absolute bottom-[-5%] right-[15%] w-[min(8vw,90px)] h-auto floating-5"
    />
    <img
      src="/images/saturn.png"
      className="absolute bottom-[-10%] left-[20%] w-[min(10vw,100px)] h-auto transform scale-x-[-1] rotate-[25deg] floating-5"
    />
    ...
    <h1 className="font-serif text-4xl md:text-4xl lg:text-5xl xl:text-7xl mb-8 leading-[1.1] italic font-light tracking-wide text-white">
      Where <em className="font-medium">Curiosity</em><br />
    ...
    <div
      onClick={() =>
        document.getElementById('unlock-potential')?.scrollIntoView({ behavior: 'smooth' })
      }
    ...
    >
      ...
      <section id="unlock-potential" className="max-w-7xl mx-auto px-6 py-24 flex flex-col md:flex-row items-center gap-10 relative z-10">
        ...
        <div className="md:w-1/3 w-full text-left">
          <h2 className="text-4xl font-bold mb-4 text-white">Unlock Your Potential Through Your Posts</h2>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {communityCards.map((card, index) => (
              <div
                key={index}
                className={`group relative overflow-hidden rounded-2xl hover:transform hover:scale-105 transition-all duration-300 ${card.shadowColor} shadow-xl hover:shadow-2xl ${
                  index % 7 === 0 ? 'md:col-span-2 h-80' :
                  index % 5 === 0 ? 'lg:row-span-2 h-96' :
                  index % 3 === 0 ? 'h-72' : 'h-64'
                }`}
              >
                {/* Background Image */}
                ...
                {/* Gradient Overlay */}
                <div className={`absolute inset-0 bg-gradient-to-t ${card.color} opacity-80 group-hover:opacity-70 transition-opacity duration-300`} />
      ...
      <section className="w-full py-20 bg-gradient-to-br from-purple-900/90 to-black/90 backdrop-blur-sm relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h3 className="text-sm uppercase tracking-wider text-purple-300 mb-4">GLOBAL RESEARCH ECOSYSTEM</h3>
            <h2 className="text-5xl font-bold text-white mb-8">Synergize With Excellence</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold text-white mb-6">Research Fellows</h3>
              <p className="text-gray-300 mb-8">Post-docs and principal investigators leading breakthrough studies</p>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold text-white mb-6">Industry Partners</h3>
              <p className="text-gray-300 mb-8">Fortune 500 companies collaborating on applied research</p>
              <div className="space-y-4 text-gray-400">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold text-white mb-6">Review Board</h3>
              <p className="text-gray-300 mb-8">Nobel laureates and journal editors ensuring research quality</p>
              <div className="space-y-4 text-gray-400">
                <p>Peer validation</p>
      ...
      <section className="py-20 relative z-10">
        ...
        <div className="flex justify-between items-center mt-6 text-gray-400 px-4 md:px-12 max-w-7xl mx-auto w-full">
          ...
          <div className="flex space-x-4">
            ...
            <a href="#" aria-label="Telegram" className="hover:text-purple-400 transition">
            ...
            <a href="#" aria-label="Email" className="hover:text-purple-400 transition">
